...
<div class="p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md border border-gray-100">
            ...
            <div class="space-y-4">
                @foreach($contestsWithSolvedCount as $index => $contestData)
                @if($index < 4)
                    ...
                    <div class="mt-3">
                        <div class="h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div class="h-full bg-purple-500 transition-all duration-500"
                                style="width: {{ ($contestData['solvedCount'] / max(1, count($contestData['contest']['problems']))) * 100 }}%">
                            </div>
                        </div>
                        <div class="text-xs text-gray-500 mt-1 text-right">
                            {{ count($contestData['contest']['problems']) }} problems total
                        </div>
                    </div>
            </div>
            @endif
        ...
        <!-- Always show the "View All Contests" button -->
        <div class="mt-4 text-center">
            <button onclick="document.getElementById('contestModal').showModal()"
    ...
    <!-- Modal (Popup for All Contests) -->
    <dialog id="contestModal" class="rounded-lg p-6 w-full max-w-lg shadow-xl backdrop:bg-black/40">
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-bold">All Contests</h3>
            <button onclick="document.getElementById('contestModal').close()"
